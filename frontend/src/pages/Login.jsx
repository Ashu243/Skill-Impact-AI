                    ...
                    <div className="relative z-10 flex w-full flex-col justify-between p-12 xl:p-16">
                        ...
                        <div className="max-w-xl">
                            ...
                            <p className="mt-6 max-w-lg text-base leading-7 text-slate-400">
                                Track what happens after training — from employment
                                and job relevance to retention, income growth,
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <button
                                            ...
                                            className="absolute right-3 top-1/2 -translate-y-1/2 p-2 text-sm text-slate-400 hover:text-slate-600"
                                        >
                                            {showPassword
                                                ? "Hide"
                                                : "Show"}
